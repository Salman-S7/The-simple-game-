...
const locations = [
  {
   ...
   "button text" :["Go to store","Go to cave","Fight Dragon"],
    ...
    text:"You are in the town square. You see that sign \"store\"."
  },
  {
   name:"Store",
  ...
  },
  {
   ...
   "button text" :["Fight Slime","Fight fanged beast","Go to town square"],
    ...
    text: "You entered the cave. You see some more monsters."
  },
    {
   name:"fight",
   ...
   "button text" :["Go to town square","Go to town square","Go to town square"],
    ...
    text: 'The monster screams "Arh!!" as it dies. You gain experince points and find gold'
  },
    {
   name:"lose",
...
function buyWeapon() {
  if(currentWeapon < weapons.length-1){
      ...
      text.innerText += "You already have most poerfull weapon!!";
...
function isMonsterhit() {
  return Math.random() > .2 || health <20; //80% of time true and 20% of time false
}
